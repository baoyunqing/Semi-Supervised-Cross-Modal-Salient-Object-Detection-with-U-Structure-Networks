...
def main():
    ...
    net = U2NET(3,1)
    net.load_state_dict(torch.load(model_dir + '/itr_12000_traLoss_0.1334_traTarLoss_0.0141_valLoss_1.6863_valTarLoss_0.2031_maxF1_0.8722_mae_0.0455_time_0.018435.pth'),strict = True)
    '''
